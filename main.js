...
function loadDemoResume() {
  resumeData = {
    basicInfo: {
      name: 'Tully',
      job: '前端开发工程师',
      education: 'XX大学 | 物联网工程（2022.09—2026.06）',
      courses: 'Web前/后端开发技术、数据结构与算法设计、计算机网络、软件工程',
      contact: '(+86) xxx-xxxx-xxxx | 1234586893@qq.com',
    ...
    honors: {
      ...
      campus: '担任XX大学小球协会会长（2024.9-至今）、获院级三好学生（2023.11）、"三下乡"社会实践活动优秀个人奖（2023.12）、参与学院网站建设项目'
    }
  };
